...
Hi! My name is Roopesh Saravanan. I am pursuing Electrical and Electronics Engineering. Here is my coding solution! I have created the symbolic link to open executable file, But I can't get access to the task title in Nodejs, which is required for adding tasks. I have researched about this in the internet, but no use. But I can get access to task title when using process.argv (`node task.js add 1 "Buy Milk"`) -> like this. But using same process.argv with symbolic link (`./task.js add 1 "Buy Milk"`) -> like this won't get access to the task ("Buy Milk") 

Other than this issue, my code works fine. I am 100% sure that you will not select me with this code. But, there is some lost hope, that's why I am writing this. If you give a chance, I'll give my 100% effort. Being from a First Graduate in my family, If I get this chance, I'll be really happy and grateful. Thanks!
